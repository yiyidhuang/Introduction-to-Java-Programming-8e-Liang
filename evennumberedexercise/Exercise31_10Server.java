...
public class Exercise31_10Server extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    primaryStage.setTitle("Exercise31_10Server"); // Set the stage title
  ...
  class ServerThread extends Thread {
      private Exercise31_10Server server;
      private Socket socket;

      /** Construct a thread */
      public ServerThread(Exercise31_10Server server, Socket socket) {
          this.socket = socket;
          this.server = server;
          start();
      }
